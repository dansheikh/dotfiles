...
COMMON_PKGS := bin emacs git kitty nvim shells wezterm
LINUX_PKGS  := hyprland noctalia uwsm
MACOS_PKGS  :=
...
help:
	...
	@echo "  tmp-clean   - Remove plugins no longer present in tmux.conf"
	@echo "  tmp-install - Install newly added plugins from tmux.conf"
	@echo "  tmp-init    - Initialize Git submodules"
	@echo "  tmp-update  - Update all currently installed plugins"
