...
hl.layer_rule({ name = "noctalia-blur", match = { namespace = "noctalia" }, blur = true })
hl.layer_rule({ name = "noctalia-alpha", match = { namespace = "noctalia-background-.*" }, ignore_alpha = 0.5 })
