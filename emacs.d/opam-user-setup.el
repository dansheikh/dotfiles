...
;; ## added by OPAM user-setup for emacs / tuareg ## 014c4e209d5a0475404f24840c910bc1 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/home/dan/.opam/system/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
